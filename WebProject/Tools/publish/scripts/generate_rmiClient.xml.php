...
$worldservice_template = '
    <bean id="worldService{VAR_SERVER_ID}" parent="abstractWorldServiceClient">
        <property name="serviceUrl" value="rmi://{VAR_IP_PORT}/WorldService"/>
    </bean>
';

$xml_template = file_get_contents(TEMPLATE_CONFIG_DIR.'/template_rmiClient.xml');
...
file_put_contents ( $out_dir . '/rmiClient.xml', $xml_content );
echo_realtime ( "done. " . $out_dir . '/rmiClient.xml' );
