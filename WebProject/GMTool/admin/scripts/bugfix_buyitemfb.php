...
$runlog = '/usr/local/cok/SFS2X/bugfix_buyitemfb.log';
// rm -f run_bugfix_buyitemfb.php.log
// rm -f /usr/local/cok/SFS2X/bugfix_buyitemfb.log

$files = array(
		'/usr/local/cok/SFS2X/buyitembug.log152',
		'/usr/local/cok/SFS2X/buyitembug.log188',
		'/usr/local/cok/SFS2X/buyitembug.log191',
		'/usr/local/cok/SFS2X/buyitembug.log194',
		'/usr/local/cok/SFS2X/buyitembug.log197',
		'/usr/local/cok/SFS2X/buyitembug.log199',
		'/usr/local/cok/SFS2X/buyitembug.log236',
		'/usr/local/cok/SFS2X/buyitembug.log263',
);
