 ...
 *
 * Import Date 2013.5.13 
 * Import By Yang Weiming
 *
 * @version 3.0.9
 * @author open.qq.com
...
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'lib/SnsNetwork.php';
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'lib/SnsSigCheck.php';
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'lib/SnsStat.php';
