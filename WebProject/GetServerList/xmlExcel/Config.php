...
define("IsXingCloudServer", false);
...
if (substr($pathParts, strlen($pathParts)-1, 1) !=  "/" ) {
	$pathParts = dirname($pathParts) . "/";
}
//echo $pathParts; exit();
$GLOBALS['protocol'] = isset($_SERVER['HTTPS']) ? "https://" : "http://";
$GLOBALS['svrPath']  = $GLOBALS['protocol']  .  $_SERVER['SERVER_ADDR'] . ":" . $_SERVER['SERVER_PORT'] . $pathParts;
