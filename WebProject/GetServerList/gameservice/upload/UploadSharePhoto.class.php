 ...
 * Time: 14:55
 */
class UploadSharePhoto
{

    protected $photo_seq = 0;

    protected $folder_name = '/data/coq_avatar/share';
    protected $file_name = '';
    ...
    public function execute($params)
    {
        ...
        file_put_contents('upload_record.log',print_r( date("Y-m-d H:i",time())."\t".$this->gameuid."\t".$this->photo_seq."\t".$this->file_name."\n",true ), FILE_APPEND );
        return $re;
    }
