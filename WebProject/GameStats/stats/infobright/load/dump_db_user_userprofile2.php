...
$dump_configs = array(
	'userprofile2' => array(
		'src' => 'userprofile',
		'export_fields' => array("date_format(from_unixtime(lastOnlineTime/1000),'%Y%m%d')",'uid','regTime',"ifnull(lastOnlineTime,0)","ifnull(deviceId,'')"),
		'import_fields' => array('date','uid','regTime','lastOnlineTime','deviceId'),
		'increment' => 'lastOnlineTime',
	),
);
