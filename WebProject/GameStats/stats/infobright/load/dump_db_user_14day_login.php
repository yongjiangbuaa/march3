...
$dump_configs = array(
	'user_14day_login' => array(
		'src' => 'user_14day_login',
		'export_fields' => array("date_format(from_unixtime(lastRewardTime/1000),'%Y%m%d')",'uid','type','ifnull(day,0)','ifnull(lastRewardTime,0)','ifnull(vipRewardTime,0)',"ifnull(reward,'')"),
		'import_fields' => array('date','uid','type','day','lastRewardTime','vipRewardTime','reward'),
		'increment' => 'lastRewardTime',
	),
);
